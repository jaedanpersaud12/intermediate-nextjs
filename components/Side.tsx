  ...
  return (
    <aside className="h-full flex flex-col bg-gradient-to-b from-white/[0.02] to-transparent">
      ...
      <div className="p-4 mt-auto">
        <Button
          variant="flat"
          className="w-full bg-gradient-to-r from-white/[0.08] to-transparent hover:from-white/[0.12] hover:to-white/[0.02] text-white/80 py-6 rounded-xl transition-all duration-300"
        >
